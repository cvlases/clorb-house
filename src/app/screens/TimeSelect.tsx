...
export default function TimeSelect() {
  ...
  return (
    <div className="bg-[#ffa2e3] relative size-full overflow-hidden" data-name="iPhone 16 - 8">
      ...
      <p className="-translate-x-1/2 absolute bottom-[75.36%] font-['Work_Sans:Medium',sans-serif] font-medium leading-[1.1] left-[calc(50%+0.5px)] text-[20px] text-black text-center top-[19.43%] w-[294px]">
        We estimate {currentTask.estimatedTime}.
      </p>

      <motion.div
        className="-translate-x-1/2 absolute left-[calc(50%+6.5px)] size-[338px] top-[248px]"
      ...
      <div className="-translate-x-1/2 absolute bottom-0 bg-[#fefdf8] border-black border-solid border-t-4 h-[327px] left-1/2 rounded-tl-[24px] rounded-tr-[24px] top-[525px] w-[390px]">
        <div className="absolute left-[29px] top-[96px] flex gap-[12px]">
          {/* Hours Picker */}
        ...
        <motion.button
          ...
          className="-translate-x-1/2 absolute bg-black content-stretch flex gap-[12px] items-center justify-center left-[calc(50%+1px)] px-[77px] py-[14px] rounded-[24px] top-[251px] w-[335px] cursor-pointer hover:bg-[#333] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          whileTap={{ scale: 0.95 }}
        >
