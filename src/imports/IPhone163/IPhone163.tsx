import svgPaths from "./svg-pknc01jnfz";
import imgUntitled500X500Px61 from "./749af56786e9c6161adfcf899904dec36b1941a5.png";

export default function IPhone() {
  return (
    <div className="bg-[#fefdf8] relative size-full" data-name="iPhone 16 - 3">
      ...
      <div className="-translate-x-1/2 absolute left-[calc(50%+13px)] size-[268px] top-[355px]" data-name="Untitled_500_x_500_px_6 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgUntitled500X500Px61} />
      </div>
      <div className="-translate-x-1/2 absolute bg-black content-stretch flex gap-[12px] items-center justify-center left-[calc(50%+2.5px)] px-[77px] py-[14px] rounded-[24px] top-[714px] w-[335px]" data-name="Button types">
